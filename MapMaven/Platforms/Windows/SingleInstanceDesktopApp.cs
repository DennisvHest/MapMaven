...
{
    /// <summary>
    /// Ensures only one instance of the application is launched even if the user opens the application when it is already running.
    /// Source: https://gist.github.com/wbokkers/af326da5391bdb13b58529e720540178
    /// </summary>
